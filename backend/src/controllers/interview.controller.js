...
async function generateInterViewReportController(req, res) {
    try {
        ...
        const interviewReport = await interviewReportModel.create({
            ...
            technicalQuestion: interViewReportByAi.technicalQuestions || interViewReportByAi.technicalQuestion,
            behaviorialQuestion: interViewReportByAi.behavioralQuestions || interViewReportByAi.behaviorialQuestion,
...
async function getAllInterviewReportsController(req, res) {
    try {
        ...
        res.status(500).json({
            message: "Internal server error while fetching all interview reports",
            error: error.message
        })
    }
}
